    ...
    <section id="three" class="wrapper style3 special">
      <div class="inner">
        ...
        <form method="post" action="changedisplayname">
         <p>Display Name : 
           <?php
           if(isset($data["displayname"]))echo $data["displayname"];
           ?>
         ...
         <form method="post" action="changepassword">
           ...
           <?php
           if(isset($data["password"]))echo $data["password"];
           ?>
           <p>Password : <input type="password" name="pwd1" /></p>
           <p>Password : <input type="password" name="pwd2" /></p>
           <p><input type="submit" value="Change Password" action="changepassword" name="changepassword"></p>
         </form>
         ...
         <form  enctype="multipart/form-data"  method="post" action="changeprofilepic">
           ...
           <p><input name="picturefile" type="file" />
           <input type="submit" name="changeprofilepic" value="Change Profile Picture"></p>
